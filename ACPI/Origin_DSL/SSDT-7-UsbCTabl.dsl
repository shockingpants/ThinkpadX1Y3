 ...
 *
 * Disassembly of SSDT-7-UsbCTabl.aml, Fri Oct  5 12:16:07 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000679 (1657)
 *     Revision         0x02
 *     Checksum         0xF6
 *     OEM ID           "LENOVO"
        ...
        Device (UBTC)
        {
            ...
            Device (CR01)
            {
                ...
                Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
                {
                    If (LEqual (USTC, One))
                    {
                        Return (\_SB.PCI0.RP09.PXSX.TBDU.XHC.RHUB.TPLD (One, 0x03))
                    }
                }
            }
            ...
            Device (CR02)
            {
                ...
                Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
                {
                    If (LEqual (USTC, One))
                    {
                        Return (\_SB.PCI0.RP09.PXSX.TBDU.XHC.RHUB.TPLD (One, 0x04))
                    }
                }
            }
